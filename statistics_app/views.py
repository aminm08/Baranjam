...
def dashboard_view(request):
    ...
    context = None
    print(dashboard.convert_labels_to_jalali_date(dashboard.get_done_dates_in_range()))
    ...
    context = {
        ...
        "labels": json.dumps(dashboard.convert_labels_to_jalali_date(dashboard.get_done_dates_in_range())),
